...
def test_variant_extraction(vcf_path, gene_name):
    ...
    try:
        ...
        if variants:
            ...
            print(f"    Example variant: Position {first_var['pos']:,}, Ref={first_var['ref']}, Alt={first_var['alt']}")
...
def test_multi_chromosome_profile(chr22_path, chr10_path):
    ...
    try:
        ...
        print(f"    {'✅' if has_cyp2c19 else '⚠️ '} CYP2C19 (may be extensive metabolizer)")
        print(f"    {'✅' if has_cyp2c9 else '⚠️ '} CYP2C9 (may be extensive metabolizer)")
...
def test_single_chromosome_profile(chr22_path):
    ...
    try:
        ...
        profile = generate_patient_profile_from_vcf(
            chr22_path,
            sample_id,
            vcf_path_chr10=None  # Single chromosome mode
        )
...
def main():
    ...
    if not files_ok:
        ...
        print("  wget https://hgdownload.cse.ucsc.edu/gbdb/hg19/1000Genomes/phase3/ALL.chr22.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf.gz")
        print("  wget https://hgdownload.cse.ucsc.edu/gbdb/hg19/1000Genomes/phase3/ALL.chr10.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf.gz")
        return
