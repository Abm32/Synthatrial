...
**Genes covered:** CYP2C19 (alleles + phenotypes), CYP2C9 (alleles), VKORC1 (rs9923231). **Warfarin** uses CYP2C9 + VKORC1 and `data/pgx/cpic/warfarin_response.json`; caller: `src/warfarin_caller.py` (`interpret_warfarin`, `interpret_warfarin_from_vcf`).
