"""
Custom Exception Classes for SynthaTrial
...
class InvalidSMILESError(SynthaTrialError):
...
class VCFProcessingError(SynthaTrialError):
...
class VectorSearchError(SynthaTrialError):
...
class LLMError(SynthaTrialError):
...
class ConfigurationError(SynthaTrialError):
...
class ChEMBLProcessingError(SynthaTrialError):
